...
- (void)drawRect:(CGRect)rect {
    ...
    if (context) {
        UIColor *coolBlue = [UIColor colorWithRed:0 green:0.557 blue:0.902 alpha:1];
        
        CGContextSetRGBFillColor(context, 0.0f, 0.0f, 0.0f, 0.7f);
        CGContextSetStrokeColorWithColor(context, coolBlue.CGColor);
